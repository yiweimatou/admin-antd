...
import SwiperSelector from '../../components/organize/SwiperSelector'
...
class Add extends Component {
    ...
    toggleVisible() {
        this.setState(prevState => ({
            visibleOrganize: !prevState.visibleOrganize
        }))
    }
    okHandler = () => {
    ...
    render() {
        const { loading, visibleOrganize } = this.state
        ...
        return (
            <div>
                <SwiperSelector visible={visibleOrganize} onCancel={this.toggleVisible} onSelect={this.selectHandler} />
