...
import { formItemLayout, LESSON } from '../../constants'
import { UPLOAD_SWIPER } from '../../constants/api'
import swiperService from '../../services/swiper'
import LessonSelect from '../../components/lesson/swiper'
...
class Add extends Component {
    ...
    toggleVisible() {
        this.setState(prevState => ({
            visibleLesson: !prevState.visibleLesson
        }))
    }
    okHandler = () => {
    ...
    render() {
        const { loading, visibleLesson } = this.state
        ...
        return (
            <div>
                <LessonSelect visible={visibleLesson} onCancel={this.toggleVisible} onSelect={this.selectHandler} />
